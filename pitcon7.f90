...
10    continue
  ...
  snl = sn
  call root_finder ( a, fa, b, fb, sn, tsn, imitl, flag, ierror )
  iwork(23) = iwork(23)+1
...
subroutine root_finder ( a, fa, b, fb, u, fu, kount, flag, ierror )
...
!
!    Output, integer FLAG, reports the status of the search.
!
...
!    as the root.
!
!    Positive values of FLAG indicated that the program has found a
...
!    will proceed with the search.  The actual value of FLAG tells
...
!  Methods available are linear interpolation, inverse quadratic interpolation,
!  and bisection.
!
